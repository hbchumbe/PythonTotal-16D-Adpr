...
# Verifica si num1 es mayor que num2, y menor que num3. Almacena 
# el resultado de dicha comparación en una variable llamada mi_bool.
...
# Verifica si num1 es mayor que num2, o menor que num3. Almacena 
# el resultado de dicha comparación en una variable llamada mi_bool.
