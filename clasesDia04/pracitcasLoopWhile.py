...
# Crea un Loop While que se imprima en pantalla los números del 10 al 0,
# uno a la vez.
contador = 10
while contador >= 0:
    print(contador)
...
# (¡recuerda que aquí puedes utilizar la operación módulo
#   dividiendo por 5 y verificando el resto!)

# - Si el número no es divisible por 5, continuar ejecutando el loop 
# sin mostrar el valor en pantalla (no te olvides de seguir restando
#  para que el programa no corra infinitamente).
numero=50
while numero >= 0:
    if numero % 5 == 0:
        print(numero)
